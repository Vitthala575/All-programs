const fruits=["Apple","mango","orange","strawbery","grapes","mango","orange"]
console.log(fruits);
console.log(typeof fruits);
console.log(`total fruits: ${fruits.length}`);
let fruits_0=fruits[0];
let fruits_3=fruits[3];
console.log(`fruits at position,${fruits_0},${fruits_3},${fruits.length},`);
//update
fruits[0]="chiku"
//traversing
console.log(`------------total elements in arry----------------`);
